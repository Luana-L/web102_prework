...
const totalRaised = GAMES_JSON.reduce( (amt,game) => {
...
const displayText = `<p>A total of $${totalRaised.toLocaleString('en-US')} has been raised for ${GAMES_JSON.length} ${(GAMES_JSON.length === 1) ? `game` : `games`}. Currently, ${unfundedGameCount} ${(unfundedGameCount === 1) ? `game remains unfunded. We need your help to fund this amazing game!`:`games remain unfunded. We need your help to fund these amazing games!`}</p>`;
